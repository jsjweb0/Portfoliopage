...
function ProfileContent({ onUpdateCheck }: WindowContentProps) {
    return (
        <div className="window-body grow">
            <div className="flex gap-x-4 pl-4">
                <div className="shrink-0 relative">
                    <img src={assetPath("images/icon/png/network_cool_two_pcs-0.png")} alt=""/>
                    <span className="dot"/>
                </div>
                    ...
                    <fieldset>
                        <legend>
                            <div className="field-row">
                                <input id="Y" type="radio" name="development" checked readOnly />
    ...
    return (
        <>
            <div className="flex justify-between bg-white px-8 py-4">
                ...
                <img src={assetPath("images/icon/png/windows_title-1.png")} alt=""/>
            </div>
                ...
                <div className=" pt-5 px-8">
                    <div className="flex gap-x-4">
                        <div className="shrink-0 h-full" aria-hidden="true">
                            <img src={assetPath("images/icon/png/installer-2.png")} alt=""/>
                        </div>
            ...
            <div className="window-body">
                ...
                <div className="window w-full" role="tabpanel">
                    <div className="window-body">
                        ...
                        <div className="flex gap-x-4">
                            <div className="shrink-0"><img src={assetPath("images/icon/png/key_win_alt-2.png")} alt=""/>
                            </div>
                            <div className="grow">
                                <ul className="tree-view overflow-y-auto h-[296px]">
                                    <li>
                                        <details open>
                                            <summary className="flex items-center"><img
                                                src={assetPath("images/icon/png/world-1.png")} className="mr-1" alt=""/> Web
                                            </summary>
                                            <ul>
                                                <li>HTML</li>
                                                <li>CSS</li>
                                    ...
                                    <li>
                                        <details>
                                            <summary className="flex items-center"><img
                                                src={assetPath("images/icon/png/kodak_imaging-1.png")} className="mr-1"
                                                alt=""/> UI
                                            </summary>
                                            <ul>
                                                <li>Figma</li>
                                    ...
                                    <li>
                                        <details>
                                            <summary className="flex items-center"><img
                                                src={assetPath("images/icon/png/directory_admin_tools-1.png")}
                                    ...
                                    <li>
                                        <details>
                                            <summary className="flex items-center"><img
                                                src={assetPath("images/icon/png/package-0.png")} className="mr-1"
                                                alt=""/> 기타
                                            </summary>
                                            <ul>
                                                <li>GitHub</li>
                                    ...
                                    <li>
                                        <details>
                                            <summary className="flex items-center"><img
                                                src={assetPath("images/icon/png/directory_open_cool-4.png")}
    ...
    return (
        <Tabs98 className="window-body" tabs={[
                    ...
                    <>
                        ...
                        <div className="flex gap-x-5">
                            <div className="shrink-0 pt-1 pl-4"><img
                                src={assetPath("images/icon/png/telephony-2.png")} alt=""/></div>
                            <div className="grow">
                                <h3 className="!text-xs font-bold font-mono">
                                    SoundCloud Player — <a href="http://newtronome.netlify.app/" target="_blank" rel="noreferrer" title="새 창 열림">▶ <span className="underline">View</span></a>, <a
                                    href="https://dashing-shroud-a2f.notion.site/SoundCloud-Player-React-Vite-Firebase-Tailwind-2536b7b5d015807a91c5cbb1fa567b97?source=copy_link" target="_blank" rel="noreferrer" title="새 창 열림">▶<span className="underline">Notion</span></a>
                                </h3>
                        ...
                        <hr className="divider"/>
                        <div className="flex gap-x-5">
                            <div className="shrink-0 pt-1 pl-4"><img src={assetPath("images/icon/png/channels-2.png")} alt=""/></div>
                            <div className="grow">
                                <h3 className="!text-xs font-bold font-mono">보호동물 — <a href="https://newtronome.netlify.app/board/pet" target="_blank" rel="noreferrer" title="새 창 열림">▶ <span className="underline">View</span></a></h3>
                                <ul className="ml-1 mt-1.5">
            ...
            },
            {
                ...
                content: (
                    <div>
                        <div><img src={assetPath("images/screenshot_project1_1.png")} alt=""/></div>
                    </div>
                )
            }
        ]}>
    ...
    return (
        <div className="window-body">
            <div className="text-center mb-3">
                <img src={assetPath("images/icon/png/entire_network_globe-0.png")} alt=""/>
            </div>
            <ul className="flex flex-col gap-y-px">
                <li><img src={assetPath("images/icon/png/envelope_closed-1.png")} alt=""/> 이메일: <a href="mailto:jsjweb0@gmail.com">jsjweb0@gmail.com</a></li>
                <li><img src={assetPath("images/icon/png/directory_open_cabinet_fc-1.png")} alt=""/> GitHub: <a href="https://github.com/jsjweb0" target="_blank" rel="noreferrer">github.com/jsjweb0</a></li>
                <li><img src={assetPath("images/icon/png/notepad-0.png")} alt=""/> 이력서 PDF: <a href="#" download>Download</a></li>
                <li><img src={assetPath("images/icon/png/msie1-4.png")} alt=""/> 사이트: <a href="https://newtronome.netlify.app" target="_blank" rel="noreferrer">newtronome.netlify.app</a></li>
            </ul>
...
export const windowComponents: Record<AboutWindowType, WindowContentComponent> = {
    about: AboutContent,
