    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          '직접 PDF 검증 후 예시 불러오기 흐름을 점검해 이전 오류 상태가 남는 문제를 발견하고, resetVersion 초기화와 같은 문제가 다시 발생하는지 확인하는 테스트 추가',
          ...
          'Codex 서브 에이전트로 구조 영향과 테스트 누락을 나눠 검토하고, 구현은 한 에이전트로 제한한 뒤 결과를 Vitest와 React Testing Library로 재확인',
