...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      '별도 문서 프로그램 없이 웹에서 이력서 등 문서 양식을 작성하고, A4 문서 형태로 실시간 확인할 수 있는 React + TypeScript 기반 문서 작성 도구입니다. 입력 폼과 문서 미리보기를 하나의 상태로 연결해 작성 내용이 즉시 반영되도록 했고, PDF 저장 전 제출용 문서 형태를 미리 점검할 수 있도록 구현했습니다.',
    tags: [
      'React',
      'TypeScript',
      'Responsive',
