...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'SoundCloud API 연동, Firebase 인증/저장, Cloudflare Workers 서버리스 프록시를 하나의 서비스 흐름으로 연결한 React 개인 프로젝트입니다. API 키 보안, 호출량 최적화, 전역 오디오 상태 관리 문제를 직접 설계해 해결했습니다.',
    tags: [
      'React',
      'API Integration',
      'Responsive',
