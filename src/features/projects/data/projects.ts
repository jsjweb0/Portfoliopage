...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      '별도 문서 프로그램 없이 웹에서 이력서와 문서를 작성하고, A4 문서 형태로 실시간 확인할 수 있는 React + TypeScript 기반 문서 작성 도구입니다.',
    description:
      '별도 문서 프로그램 없이 웹에서 이력서와 문서를 작성하고, A4 문서 형태로 실시간 확인할 수 있는 React + TypeScript 기반 문서 작성 도구입니다. 입력 폼과 문서 미리보기를 하나의 상태로 연결해 작성 내용이 즉시 반영되도록 했고, PDF 저장 전 제출용 문서 형태를 미리 점검할 수 있도록 구현했습니다.',
    tags: [
      'React',
      'TypeScript',
      'Responsive',
    ...
    sections: [
      {
        ...
        title: 'Overview',
        content:
          '국문 이력서를 작성할 때 입력 누락, 작성 중 데이터 손실, 미리보기와 출력 결과 불일치가 생기면 실제 제출 도구로 신뢰하기 어렵다고 판단했습니다.\n\n이를 해결하기 위해 하나의 Resume 상태를 기준으로 입력 폼과 A4 미리보기를 연결하고, localStorage 저장/복원, 입력값 검증, 오류 필드 포커스 이동, print CSS 기반 PDF 저장 흐름을 구현했습니다.\n\n그 결과 작성, 검증, 저장, 출력까지 이어지는 국문 이력서 작성 MVP를 완성했고, React 상태 설계와 TypeScript 모델링, 접근성 개선을 실제 문서 작성 흐름 안에서 연습할 수 있었습니다.',
      },
      {
        type: 'work',
        title: 'Key Work',
